...
def sign_pdf(
   ...
   with fitz.open(pdf) as f:
       ...
       for page_num, page in enumerate(f):
           ...
           main_x0 = main_coords["x0"]
           main_y0 = main_coords["y0"]
           sub_x0 = sub_coords["x0"]
           sub_y0 = sub_coords["y0"]
           main_sign = (main_x0, main_y0, main_x0 + width, main_y0 + height)
           sub_sign = (sub_x0, sub_y0, sub_x0 + width, sub_y0 + height)
           random_sub_sign = get_random_sign(sub_sign_path)
           page.insert_image(main_sign, filename=main_sign_path)
           page.insert_image(sub_sign, filename=random_sub_sign)
